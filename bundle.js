...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener("DOMContentLoaded", function () {
	  ReactDOM.render(React.createElement(ReactMinesweeper, null), document.getElementById('main'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ReactDOM = __webpack_require__(158);
	var ReactBoard = __webpack_require__(160);
	var Minesweeper = __webpack_require__(161);
	...
	var Game = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(ReactBoard, { gameBoard: this.state.board, updateGameFunc: this.updateGame });
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOM = __webpack_require__(158);
	var Minesweeper = __webpack_require__(161);
	var ReactTile = __webpack_require__(162);
	
	var ReactBoard = React.createClass({
	  displayName: 'ReactBoard',
	      ...
	      this.props.gameBoard.grid.map(function (el, idxRow) {
	        return React.createElement(
	          ...
	          el.map(function (tile, idxCol) {
	            return React.createElement(ReactTile, { key: idxCol, row: idxRow,
	              gameBoard: that.props.gameBoard });
	          })
	        );
	      })
	    );
	...
	var ReactTile = React.createClass({
	  ...
	  render: function () {
	    ...
	    if (currTile.explored && !currTile.bombed) {
	      ...
	      return React.createElement('div', { 'class': 'blank' });
	    }
	  }
	});
